...
export default class Level5 extends Phaser.Scene{
    ...
    initUI(){
         this.add.text(configItems.width/2,15,"Level 5",{'fontSize':'24px','fill': '#fff'}).setOrigin(.5,.5);
    ...
    createBlocks(){
        ...
        let g3 = this.physics.add.staticImage(configItems.width * 2/4,window.innerHeight * .6,'tile')
        .setOrigin(0.5,1)
        .setScale(1,1.5).refreshBody();

        let g33 = this.physics.add.staticImage(configItems.width * 1.3/4,window.innerHeight * .6 - 25,'tile')
        .setOrigin(0.5,1)
        .setScale(2.5,2.5).refreshBody();

        let g31 = this.physics.add.staticImage(configItems.width * 2.5/4,window.innerHeight * .6 - 25,'tile')
        .setOrigin(0.5,1)
        .setScale(2.5,2.5).refreshBody();

        let g32 = this.physics.add.staticImage(configItems.width * 3/4,window.innerHeight * .6,'tile')
        .setOrigin(0.5,1)
        .setScale(1,1).refreshBody();
        ...
        g1.tint = g2.tint =  g21.tint = g3.tint = g4.tint = g5.tint = g31.tint = g32.tint = g33.tint = g6.tint = configItems.obstacleColor;
